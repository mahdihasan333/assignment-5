...
// Donate Buttons
const donateBtn1 = id("Donate-now-btn1");
const donateBtn2 = id("Donate-now-btn2");
const donateBtn3 = id("Donate-now-btn3");
...
donateBtn1.addEventListener("click", function () {
  const inputAmount1 = parseFloat(id("donateValue").value);
